...
load(file=paste0("/well/todd/users/jinshaw/aad/under_7/results/",snpname,"_3.RData"))
return(l)
}
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/inds_het_tests_all_inc_midrange_3.png", res=800,
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/inds_het_tests_all_inc_midrange_3_sm.png", res=800,
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/het_tests_all_inc_midrange_no_nonsig_3.png", res=800,
width=40, height=30, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/het_tests_all_inc_midrange_no_nonsig_3_sm.png", res=800,
width=25, height=20, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()
...
load(file="/well/todd/users/jinshaw/aad/under_7/pheno_mult_3.R")
r<-read.table(file="/well/todd/users/jinshaw/aad/under_7/results/inds_likelihoods_redo_3.txt",
...
ggsave(d,file=paste0("/well/todd/users/jinshaw/output/aad/under_7/mafs/redo_2/",gsub("/"," ",t1dsnps[t1dsnps$id==snp,"loci"]),"_by_allele_3.png"),
dpi=800, height=20, width=25, units="cm")
}
...
ggsave(g,file=paste0("/well/todd/users/jinshaw/output/aad/under_7/mafs/redo_2/",gsub("/"," ",t1dsnps[t1dsnps$id==snp,"loci"]),"_all_3.png"),
dpi=800, height=20, width=25, units="cm")
}
