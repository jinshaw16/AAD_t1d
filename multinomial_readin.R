...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/inds_het_tests_all_inc_midrange_n.png", res=800,
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/inds_het_tests_all_inc_midrange_n_sm.png", res=800,
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/het_tests_all_inc_midrange_no_nonsig_n.png", res=800,
width=40, height=30, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/het_tests_all_inc_midrange_no_nonsig_n_sm.png", res=800,
width=25, height=20, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()
...
ggsave(d,file=paste0("/well/todd/users/jinshaw/output/aad/under_7/mafs/redo_1/",gsub("/"," ",t1dsnps[t1dsnps$id==snp,"loci"]),"_by_allele_n.png"),
...
ggsave(g,file=paste0("/well/todd/users/jinshaw/output/aad/under_7/mafs/redo_1/",gsub("/"," ",t1dsnps[t1dsnps$id==snp,"loci"]),"_all_n.png"),
dpi=800, height=20, width=25, units="cm")
}
