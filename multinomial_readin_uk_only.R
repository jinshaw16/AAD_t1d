...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo/uk/inds_het_tests_all_inc_midrange_n.png", res=800,
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo/uk/het_tests_all_inc_midrange_no_nonsig_n.png", res=800,
width=40, height=30, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()
