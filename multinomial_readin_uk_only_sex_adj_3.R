#multinomial_readin_uk_only_sex_adj_3.R
library(ggplot2)
library(gridExtra)
...
getlik<-function(snp){
load(file=paste0("/well/todd/users/jinshaw/aad/under_7/results/uk/",snp,"_sex_adj.RData"))
return(l)
}
...
write.table(likelihoods, file="/well/todd/users/jinshaw/aad/under_7/results/uk/inds_likelihoods_redo_n_sex_adj_3.txt",
col.names=T, row.names=F, quote=F, sep="\t")

likelihoods<-read.table(file="/well/todd/users/jinshaw/aad/under_7/results/uk/inds_likelihoods_redo_n_sex_adj_3.txt",
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/uk/inds_het_tests_all_inc_midrange_n_sex_adj_3.png", res=800,
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/uk/inds_het_tests_all_inc_midrange_n_sex_adj_3_sm.png", res=800,
width=25, height=20, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()

pdf(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/uk/inds_het_tests_all_inc_midrange_n_sex_adj_3_sm.pdf", 
width=10, height=7)
grid.arrange(one,two,ncol=2)
dev.off()
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/uk/het_tests_all_inc_midrange_no_nonsig_n_3_sex_adj.png", res=800,
width=40, height=30, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()
...
png(file="/well/todd/users/jinshaw/output/aad/under_7/multinom/redo_1/uk/het_tests_all_inc_midrange_no_nonsig_n_sex_adj_3_sm.png", res=800,
width=25, height=20, units="cm")
grid.arrange(one,two,ncol=2)
dev.off()
